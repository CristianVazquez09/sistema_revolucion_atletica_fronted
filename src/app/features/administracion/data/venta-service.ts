...
import { VentaData } from '../models/venta-data';
import { HttpClient, HttpParams } from '@angular/common/http';
import { environment } from '../../../../environments/environment';
import { GenericService } from '../../../core/http/generic-service';
import { VentaCreateRequest } from '../models/venta-create';
import { map, Observable } from 'rxjs';
import { VentaPatchRequest } from '../models/venta-patch';
...
export class VentaService extends GenericService<VentaData> {
  ...
  crearVenta(payload: VentaCreateRequest): Observable<VentaData> {
    return this.http.post<VentaData | VentaData[]>(this.url, payload).pipe(
